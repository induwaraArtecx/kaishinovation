...
export default function Footer() {
  return (
    <footer className="bg-brand-blue-dark text-slate-300 pt-20 pb-8 border-t border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-10 pb-16 border-b border-white/5 text-left">
        ...
        <div className="flex flex-col items-start gap-6">
          ...
          <div className="flex gap-4">
            <a href="#" className="w-8 h-8 rounded-full bg-white/5 border border-white/10 hover:border-brand-cyan flex items-center justify-center hover:text-white hover:bg-brand-cyan/20 transition-all" aria-label="LinkedIn">
